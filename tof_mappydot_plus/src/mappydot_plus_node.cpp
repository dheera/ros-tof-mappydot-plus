/* mappydot_plus_node.cpp
 * Author: Dheera Venkatraman <dheera@dheera.net>
 *
 * Instantiates a MappyDotPlus Activity class, as well as
...
int main(int argc, char *argv[]) {
    ...
    tof_mappydot_plus::MappyDotPlusActivity* activity = NULL;
    ...
    activity = new tof_mappydot_plus::MappyDotPlusActivity(*nh, *nh_priv);
